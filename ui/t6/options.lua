...
LUI.createMenu.OptionsMenu = function ( f43_arg0 )
	...
	f43_local0:registerEventHandler( "pause_hard", CoD.Options.PauseHard )
	...
	if UIExpression.IsInGame() == 1 and CoD.isZombie == true then
		...
		f43_local_roundText:setLeftRight( false, true, -300, -50 )
		f43_local_roundText:setTopBottom( true, false, 40, 40 + CoD.textSize.Default )
		f43_local_roundText:setFont( CoD.fonts.Default )
		f43_local_roundText:setAlignment( LUI.Alignment.Right )
		
		local currentRound = UIExpression.DvarInt( f43_arg0, "ui_zm_round" )
		
		f43_local_roundText:setText( "PAUSED AT ROUND " .. tostring( currentRound ) )
